// src/lib.rs
/*
 * Core library for ManticoreInfura
 */
...
#[derive(Debug)]
pub struct ManticoreInfuraProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ManticoreInfuraProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ManticoreInfura processing");
    
    let mut processor = ManticoreInfuraProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ManticoreInfuraProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ManticoreInfuraProcessor::new(false);
